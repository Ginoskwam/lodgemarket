...
export default function MessagesPage() {
  ...
  async function handleDeleteConversation(conversationId: string) {
    if (!confirm('Êtes-vous sûr de vouloir supprimer cette conversation ? Elle sera masquée pour vous mais restera visible pour l\'autre personne.')) {
      return
    }
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="body-text text-charbon-secondary">
                ...
                {totalUnread > 0 && (
                  <span className="ml-2">
                    • <span className="text-primary font-semibold">{totalUnread} non lu{totalUnread > 1 ? 's' : ''}</span>
                  </span>
                )}
              </p>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                <label className="text-sm font-medium text-charbon-text whitespace-nowrap">Trier par :</label>
                <select
                  value={sortBy}
        ...
        {!conversations || conversations.length === 0 ? (
          <div className="card p-12 text-center">
            ...
            <h2 className="heading-3 mb-2">Aucune conversation</h2>
            <p className="body-text text-charbon-secondary mb-8">
              Contactez un propriétaire depuis une annonce pour commencer à échanger
            </p>
            <Link href="/annonces" className="btn-primary inline-block">
              Voir les annonces
            </Link>
          </div>
